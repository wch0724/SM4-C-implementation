 ...
 * 2012-4-20
 * developer:rapha
 * email:wch0724@bupt.edu.cn
 * 2019-3-12
 */

// Test vector 1
// plain: 01 23 45 67 89 ab cd ef fe dc ba 98 76 54 32 10
// key:   01 23 45 67 89 ab cd ef fe dc ba 98 76 54 32 10sm4_crypt_ecb
...
void sm4_setkey_dec( sm4_context *ctx, unsigned char key[16] )
{
    ...
    for( i = 0; i < 16; i ++ )
    {
        SWAP( ctx->sk[ i ], ctx->sk[ 31-i] );  //½âÃÜËã·¨µÄÂÖÃÜÔ¿ÊÇ¼ÓÃÜËã·¨ÂÖÃÜÔ¿µÄµ¹Ðò
    }
}
                    ...
                    unsigned char *output )
{
    ...
    else if( mode == SM4_DECRYPT) /* SM4_DECRYPT */
    {
        while( length > 0 )
        {
